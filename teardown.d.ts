...
/**
 * @param {value} vehicle_ Handle to vehicle or zero to not drive.
 */
declare function SetPlayerVehicle(vehicle_: value): void;
/**
...
/**
 * @param {int} type_ Tile in the particle texture atlas (0-15)
 */
declare function ParticleTile(type_: int): void;
/**
